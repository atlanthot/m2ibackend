...
class Articles extends \AppBundle\Entity\Articles implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Articles' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Articles' . "\0" . 'category', '' . "\0" . 'AppBundle\\Entity\\Articles' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Articles' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Articles' . "\0" . 'id_user', '' . "\0" . 'AppBundle\\Entity\\Articles' . "\0" . 'creationDate', '' . "\0" . 'AppBundle\\Entity\\Articles' . "\0" . 'modificationDate'];
        }
