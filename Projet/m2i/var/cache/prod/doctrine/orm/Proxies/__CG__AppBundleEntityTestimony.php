 ...
 */
class Testimony extends \AppBundle\Entity\Testimony implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Testimony' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Testimony' . "\0" . 'msg', '' . "\0" . 'AppBundle\\Entity\\Testimony' . "\0" . 'creationDate', '' . "\0" . 'AppBundle\\Entity\\Testimony' . "\0" . 'modificationDate', '' . "\0" . 'AppBundle\\Entity\\Testimony' . "\0" . 'idUser'];
        }
