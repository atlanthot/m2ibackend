 ...
 */
class Pitcures extends \AppBundle\Entity\Pitcures implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pitcures' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Pitcures' . "\0" . 'img', '' . "\0" . 'AppBundle\\Entity\\Pitcures' . "\0" . 'idArticle'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pitcures $proxy) {
